...
namespace AuditSystem.Services
{
    public class InternationalReferalMasterServices
    {
        ...
        public TblInternationalReferalMaster GetByName(string code)
        {
            return _context.TblInternationalReferalMasters.SingleOrDefault(d => d.Code.Equals(code));
        }

        public MessageModel Insert(TblInternationalReferalMaster obj)
        {
            ...
            try
            {
                ...
                if (data == null)
                {
                    _context.TblInternationalReferalMasters.Add(obj);
        ...
        public TblInternationalReferalMaster GetById(int Id)
        {
            return _context.TblInternationalReferalMasters.SingleOrDefault(i => i.Id == Id);
        }


        public MessageModel Update(TblInternationalReferalMaster obj)
        {
            try
            {
        ...
        public MessageModel Delete(TblInternationalReferalMaster obj)
        {
            try
            {
                var dbobj = GetById(obj.Id);
