...
{
    public class InternationalReferalMasterController : Controller
    {
        readonly InternationalReferalMasterServices _ClientService = new InternationalReferalMasterServices();
        ...
        {
            var model = new InternationalReferalMasterModel()
            {
                IsActive = true,
            };
        ...
        [HttpPost]
        public ActionResult Create(InternationalReferalMasterModel masterModel)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    TblInternationalReferalMaster tbl = new TblInternationalReferalMaster();
                    {
        ...
        [HttpPost]
        public ActionResult Edit(InternationalReferalMasterModel masterModel)
        {
            try
            {
                if (ModelState.IsValid)
