...
{
    public class IntroductionMasterController : Controller
    {
        readonly IntroductionMasterServices _ClientService = new IntroductionMasterServices();
        ...
        [HttpPost]
        public ActionResult Create(IntroductionMasterModel masterModel)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    TblIntroductionMaster tbl = new TblIntroductionMaster();
                    {
        ...
        public ActionResult Edit(int Id)
        {
            ...
            var model = new IntroductionMasterModel()
            {
                Id = dt.Id,
                Code = dt.Code,
        ...
        [HttpPost]
        public ActionResult Edit(IntroductionMasterModel masterModel)
        {
            try
            {
                if (ModelState.IsValid)
